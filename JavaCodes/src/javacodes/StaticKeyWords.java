...
//
//     static variables: created in the class,
...
//
    ...
    public static void main(String[] args) {
        ...
        StaticKeyWords.method1();
        // (static keyword )can be call with classname and method name

        //StaticKeyWords.method2();
        //(method without static keyword) cannot call with classname and method name
